    ...
    try {
        ...
        return {
            ...
            exam: {
                ...
                sessionCount:
                    exam.sessions.filter(function (s) {
                        return s;
                    }).length - 1,
                statistics: {
                ...
                sessions: exam.sessions
                    ...
                    .map(function (session, idx) {
                        ...
                        return {
                            ...
                            classroomCount:
                                session.classrooms.filter(function (c) {
                                    return c;
                                }).length - 1,
                            departmentGradeStats:
                                session.departmentGradeStatistics,
                        };
                    })
                    .filter(function (s) {
                        return s !== null;
...
function doGet(e) {
    var mode =
        e && e.parameter && e.parameter.mode ? e.parameter.mode : "viewer";
